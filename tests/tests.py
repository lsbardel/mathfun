...
from mathfun.prime_numbers import factors, prime_factors
...
class TestMath(unittest.TestCase):
    ...
    def test_factors(self):
        ...
        self.assertEqual(fs(1210), [1, 2, 5, 10, 11, 22, 55, 110, 121, 242, 605])

    def test_factor_cache(self):
        cache = {}
        for n in range(1000, 1, -1):
            factors(n, cache)
        self.assertEqual(fs(220, cache), [1, 2, 4, 5, 10, 11, 20, 22, 44, 55, 110])
